...
from cdskit.util import parallel_map_ordered, read_gff, read_seqs, resolve_threads, write_gff, write_seqs
...
def filter_record_chunk_by_names(record_chunk, names):
    return [record for record in record_chunk if record.name in names]
