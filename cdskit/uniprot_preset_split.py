...
def split_uniprot_eukaryota_tsv(
    input_tsv, out_dir, out_prefix="", lineage_col="", report_json=""
):
    ...
    split_rows, count_missing_lineage, count_non_eukaryota = (
        split_rows_by_eukaryota_presets(
            rows=rows,
...
def main(argv=None):
    ...
    exclude_fragments = parse_yes_no(
        args.uniprot_exclude_fragments, "--uniprot_exclude_fragments"
    )
